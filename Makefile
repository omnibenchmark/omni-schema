...
RUN = /home/almut/softs/poetry/bin/poetry run
...
install:
	/home/almut/softs/poetry/bin/poetry install
.PHONY: install
...
update-linkml:
	/home/almut/softs/poetry/bin/poetrypoetry add -D linkml@latest
...
examples/output: src/omni_schema/schema/omni_schema.yaml
	mkdir -p $@
